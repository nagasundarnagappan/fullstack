...
const Home = () => {
    ...
    <div class="mx-auto max-w-screen-xl items-center sm:py-16 md:grid md:grid-cols-2 lg:px-6 xl:gap-16">
      ...
      <div class="mt-4 md:mt-0">
        ...
        <a href="/user/services" class="mt-4 bg-primary-700 border-2 border-blue-800 bg-blue-800 hover:bg-primary-800 focus:ring-primary-300 inline-flex items-center rounded-lg px-5 py-2.5 text-center text-sm font-medium text-white focus:ring-4">
          View all Services
